...
Route::group([
    ...
    // Route::get('/adminpage', [App\Http\Controllers\PlayerController::class], 'demo');
});
Auth::routes();
...
//     'middleware' => ['admin']
// ], function () {
//     Route::get('/admin/profile', [App\Http\Controllers\Admin\UserController::class, 'GetProfile'])->name('profile');
//     Route::post('/admin/profile', [App\Http\Controllers\Admin\UserController::class, 'PostProfile'])->name('profile');
// });
...
Route::get('/member/login', [FrontendUserController::class, 'GetLogin'])->name('login');
Route::post('/member/login', [FrontendUserController::class, 'PostLogin'])->name('login');
...
Route::get('/member/searchadvance', [FrontendDashboardController::class, 'SearchAdvance'])->name('member.searchadvance');
