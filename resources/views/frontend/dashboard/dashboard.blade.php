...
<style>
    .find_box {
        display: flex;
        /* cho các phần tử con nằm cùng hàng */
        gap: 10px;
...
<div class="col-sm-9 padding-right">
    <div class="features_items">
        ...
        <!-- <div class="search"> -->
        <form action="{{url('/member/searchadvance')}}" method="post">
            @csrf
            <div class="find_box ">
                <input type="text" class="search" name="search" placeholder="Name" />
            ...
            <button type="submit" name="btn_search_advance">Search</button>
        </form>
