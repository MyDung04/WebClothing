                ...
                <tbody>
                    ...
                    <tr>
                        <td class="cart_product">
                            <!-- co th thay the asset thanh url, vi da luu bang duong dan tuyet doi( co the truy cap bang web) -->
                            <a href=""><img style="width: 100px; height: 100px;"
                                    src="{{ asset('frontend/images/products/' . $item['image']) }}" alt=""></a>
                        </td>
